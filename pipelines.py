...
class GplayPipeline(object):  
    ...
    def __init__(self):  
        self.conn = psycopg2.connect("dbname='gplay' user='postgres' host='localhost' password='justin'")
##        self.links_seen = []
